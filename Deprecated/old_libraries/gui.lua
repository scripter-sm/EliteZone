...
do
	...
	local ezAssets = {
		...
		['Elite Zone/Assets/logo.png'] = 'rbxassetid://109639965083338',
...
components = {
	...
	Category = function(props, children, api)
		...
		title.FontFace = uipallet.Font
		local titleInset = props.Size.X.Offset > 18 and 40 or 33
		title.Size = UDim2.new(1, -titleInset, 0, 41)
	...
	CategoryList = function(props, children, api)
		...
		title.FontFace = uipallet.Font
		title.Name = 'Title'
		local titleInset = props.Size.X.Offset > 20 and 44 or 36
		title.Size = UDim2.new(1, -titleInset, 0, 20)
		title.Position = UDim2.fromOffset(titleInset, 12)
	...
	ColorSlider = function(props, children, api)
		local pickers = props.Pickers or {props}
		local count = #pickers
		...
		title.Size = UDim2.new(1, -(32 + (count - 1) * 20), 0, 32)
		title.Text = props.Name
		title.TextColor3 = color.Dark(uipallet.Text, 0.16)
		title.TextSize = 11
		title.TextXAlignment = Enum.TextXAlignment.Left
		...
		local function addPicker(index, info)
			local component = {
				Type = 'ColorSlider',
				Hue = info.DefaultHue or 0.44,
			...
			local hasAlpha = info.Transparency == true
			local callback = info.Function or function() end
			...
			api.Options[info.Name] = component
			return component
		end
		
		local built = {}
		for index, info in pickers do
			built[info.Name] = addPicker(index, info)
		end
		
		return props.Pickers and built or built[props.Name]
	...
	GUI = function(props, children, api)
		...
		logo.Size = UDim2.fromOffset(32, 20)
		logo.Parent = window
		local title = Instance.new('TextLabel')
		...
		title.FontFace = uipallet.Font
		title.Name = 'Title'
		title.Position = UDim2.fromOffset(46, 20)
	...
	SearchBar = function(props, children, api)
		...
		box.PlaceholderText = ''
		box.Position = UDim2.fromOffset(33, 0)
		box.Size = UDim2.new(1, -43, 0, 37)
		box.Text = ''
